...
const { createFile, uploadProjectFile, editFileName, deleteFile, updateFile, uploadFilePath } = require('../controllers/fileControllers')
...
fileRouter.route('/upload-path').post(ProtectRoute ,multer().single('file'), uploadFilePath)
